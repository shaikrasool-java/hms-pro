...
<body>
 ...
 -->
	<section class="container"> <form:form method="post"
		action="./patientMgmt/addPatient" modelAttribute="patBean" class="form-horizontal">
		...
		<fieldset>
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="manufacturer">Confirm
					Password</label>
				<div class="col-lg-10">
			...
			<div class="form-group">
				<label class="control-label col-lg-2 col-lg-2" for="name">Mobile</label>
				<div class="col-lg-10">
