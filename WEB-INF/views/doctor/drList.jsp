...
<jsp:include page="./drBodyHeader.jsp"></jsp:include>
</head>
<script>
	function myFunction() {
		...
		<table class="table table-striped table-hover">
			...
			<div>
				...
				<tr>
					...
					<td><a href="${pageContext.request.contextPath}admin/editDr/${dr.id}" class="btn btn-primary" role="button"data-toggle="tooltip" title="Edit!"><i class="fa fa-edit">  Edit</a></td>
					<td><a href="${pageContext.request.contextPath}/doctor/deleteDr/${dr.id}" class="btn btn-danger" role="button" onclick="myFunction()" data-toggle="tooltip" title="Delete!"><i class="fa fa-trash">  Delete</a></td>
